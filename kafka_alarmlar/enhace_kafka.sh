...
ALARM_TIME=15
KAFKA_SERVER="172.31.229.205:9092"
KAFKA_TOPICS=("VPAY_EMAIL_HISTORY" "VPAY_LOGIN_HISTORY" "VPAY_MERNIS_HISTORY" "VPAY_PHONE_HISTORY" "MOBILE_PAYMENTS_RESPONSES" "MOP_PURCHASE" "MOP_REFUND" "MOP_RENEWAL" "MOP_STATUS_CHANGES" "MOP_SUB_CANCEL"
 "OTP_SENT" "OTP_VALIDATED" "PAYCORE_TRANSACTIONS" "PGW_PAYMENT_NOTIFICATIONS" "WALLET_CUSTOMER_UPDATE" "VPAY_KYC")
